...
export default function RegalPopup({
  ...
  console.log("Regal Fire Events:", fireEvents);
  console.log("Regal Fault Events:", faultEvents);
  console.log("Regal Sys Fault Events:", sysFaultEvents);
  console.log("Regal Activated Events:", activatedEvents);
  ...
  return (
    <div className="regal-event-container">
      ...
      {/* Last Updated Time */}
      {/* {(time || date) && (
        <div className="regal-update-time">
          <div className="regal-time-text">Last Updated</div>
          <div className="regal-time-value">{date} {time}</div>
        </div>
      )} */}
