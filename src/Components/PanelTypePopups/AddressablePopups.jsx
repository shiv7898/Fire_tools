  ...
  return (
    <div className="addressable-event-container">
      ...
      <div className="addressable-status-grid">
        <div
          className={`addressable-status-item ${led_status.main == 1 ? "green" : "gray"
            }`}
        >
        ...
        <div
          className={`addressable-status-item ${led_status.fire == 1 ? "red" : "gray"
            }`}
        >
          <div className="add_icon_background">
        ...
        <div
          className={`addressable-status-item ${led_status.fault == 1 ? "yellow" : "gray"
            }`}
        >
          <div className="add_icon_background">
        ...
        <div
          className={`addressable-status-item ${led_status.sil == 1 ? "yellow" : "gray"
            }`}
        >
          <div className="add_icon_background">
            {" "}
        ...
        <div
          className={`addressable-status-item ${led_status.sys == 1 ? "blue" : "gray"
            }`}
        >
          <div className="add_icon_background">
        ...
        <div
          className={`addressable-status-item ${led_status.pre == 1 ? "yellow" : "gray"
            }`}
        >
          <div className="add_icon_background">
        ...
        <div className="addressable-container">
          <div className="addressable-status-container">
            ...
            <div className="addressable-tabs">
              <button
                className={`addressable-tab ${activeTab === "fire" ? "active fire" : ""
                  }`}
              ...
              <button
                className={`addressable-tab ${activeTab === "fault" ? "active fault" : ""
                  }`}
              ...
              <button
                className={`addressable-tab ${activeTab === "activated" ? "active activated" : ""
                  }`}
              ...
              <button
                className={`addressable-tab ${activeTab === "sysfault" ? "active sysfault" : ""
                  }`}
