    ...
    <div className="login-container">
      <div className="login-bg">
        ...
        <form className="login-form" onSubmit={handleSubmit}>
          <div className="logo-circle-for-mobile">
            <img src="/img/app_icon.png" alt="App Logo" className="app-logo" />
          </div>
          {/* <div className="welcome-text-for-mobile">Welcome To</div> */}
          <div className="signin-text-for-mobile">M2R Connect</div>
          ...
          <div className="login-field password-field">
            ...
            <div className="input-icon-wrapper password-input">
              ...
              >
                {showPassword ? <IoEyeOffOutline className="eye_icon" /> : <IoEyeOutline className="eye_icon" />}
              </button>
            </div>
          </div>

          <div className="below-password-row">
            <div className="forgot" onClick={() => navigate("/reset-password")}>Forgot Password?</div>
