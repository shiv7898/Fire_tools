...
const RegalPopup = ({ panel , onClose }) => {
  ...
  return (
   ...
   <div className="panel-status-grid-two">
     ...
     <div className="status-item">
       ...
       <div className="status-item">
       <span className="status-icon sil-alarm"><MdWrongLocation /></span>
       <span className="status-label">ZONE ISO</span>
     </div>
      <div className="status-item">
       <span className="status-icon sil-alarm"><MdDirectionsRun /></span>
